            ...
            <div id="wd-h-tag">
                ...
                <div id="wd-lists">
                    ...
                    <ol id="wd-your-favorite-recipe">
                        <li>Preheat an electric griddle or pan to 350°F.</li>
                        <li>Mix dry ingredients.</li>
                        <li>Add wet ingredients.</li>
                        <li>Spray pan or griddle with cooking spray.</li>
                        <li>Drop desired amount of pancake batter onto griddle or pan.</li>
                        <li>Cook until small bubbles form.</li>
                        <li>Flip until bottom is a light golden brown.</li>
                        <li>Serve plain or with maple syrup and enjoy!</li>
                    </ol>
                ...
                <div id="wd-tables">
                    ...
                    <table border={1} width="100%">	{/* table, border, width */}
                        ...
                        <tfoot>					    {/* table row */}
                            <tr>
                                <td colSpan={10}>Average</td>	{/* column span */}
                                <td>90</td>
                            </tr>
                        </tfoot>
                    </table>
